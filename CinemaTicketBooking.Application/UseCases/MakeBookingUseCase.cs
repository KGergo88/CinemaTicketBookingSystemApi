...
internal class MakeBookingUseCase
{
    ...
    public async Task<Booking> ExecuteAsync(Guid customerId, Guid screeningId, List<Guid> seatsToReserve)
    {
        ...
        {
            throw new MakeBookingException($"Could not reserve seats! Error: \"{exception.Message}\"");
        }
